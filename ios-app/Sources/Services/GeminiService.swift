...
class GeminiService: NSObject, LLMProvider, URLSessionDataDelegate {
    ...
    func generateStream(prompt: String, model: String, apiKey: String, onMessage: @escaping (String) -> Void, onComplete: @escaping () -> Void) {
        ...
        // Use v1beta for broader compatibility and stability in 2026
        let correctedModel = model.contains("gemini-3.1") ? model : "gemini-3.1-pro-preview"
        ...
        // Simplified body to avoid quota issues with 'Thinking' or 'MediaResolution'
        let body: [String: Any] = [
            "contents": [
                ["parts": [["text": prompt]]]
            ],
